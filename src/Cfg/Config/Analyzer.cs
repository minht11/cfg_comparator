...
namespace Cfg.Config
{
    ...
    {
        /// <summary>
        /// Compares two configuration <see cref="Cfg.Config.Record" />s.
        /// </summary>
        /// <param name="source">The source configuration <see cref="Cfg.Config.Record" /></param>
        /// <param name="source">The target configuration <see cref="Cfg.Config.Record" /></param>
